...
class UtilsLib
{
    ...
    function ActionUrl( $params )
    {
    	...
    	$action_url = \Kuink\Core\Tools::setUrlParams($baseurl, array ('action' => $action_name));
    ...
    function ActionUrlLink( $params )
    {
    	...
    	$action_name = (string)$params[0];
    	$baseurl = $this->nodeconfiguration['baseurl'];
    	$url = new moodle_url($baseurl, array ('action' => $action_name));
    ...
    function EventUrlLink( $params )
    {
    	...
    	$baseurl = $this->nodeconfiguration['baseurl'];
    	$url = new moodle_url($baseurl, array ('event' => $event_name, 'action'=>'', 'actionvalue'=>''));
     ...
     * @param 0 string to split
     * @param 1 pattern to split. Default: Comma ","
    ...
    /**
    * @param 0 Element to search
    * @param 1 Array (1 dimension) to perfom search
    **/
