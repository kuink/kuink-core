...
class FileLib {
    ...
    /**
     *
     * @param $params (id, delete_file_record=true)
     * @throws Exception
     */
    function unlink( $params )
    {
        ...
        $file = $datasource->execute(array('table'=>'fw_file', 'id'=>$id));
    	//var_dump($file);
    	...
    	if ($delete_file_record == 'true') {
    		...
    		$file = $datasource->execute(array('table'=>'fw_file', 'id'=>$id, 'unlinked'=>1));
    	}
    	//var_dump($file);
    	return;
    }
    ...
    * @param id original file id from fw_file table
    * @param path destination path
    * @param newName if is setted, the new file will be renamed to this name
    * @return New file id
    ...
    **/
    function createFolder($params){
		...
		/**
    * create the record's folder
    * @param originalPath folder's original path
		* @param destinationPath folder's destination path
    * @author André Bittencourt
    * @since 2015-07-27
    **/
