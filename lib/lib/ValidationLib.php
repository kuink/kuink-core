...
class ValidationLib
{
     ...
     * @param Array $params Parameters array. The postal code to validate is in this array
     ...
     * @param Array $params Parameters array. The string to validate is in this array
     * @throws Exception Invalid parameters number
     ...
     * @param Array $params Parameters array. The identity number to validate is in this array
     ...
     * @param Array $params Parameters array. The identity date to validate is in this array and the current date
     ...
     * @param Array $params Parameters array. The civil card number to validate is in this array
     * @throws Exception If the number of parameter isn't exactly one
     * @return True if is valid, False otherwise
     */
     ...
     * @param Array $params Array with the [0]document number and [1]the document type. The document type must be an integer.
    ...
    function iddoc_number($params){
    	...
    	switch ($doc_type){
    		case 1: //portuguese identification number
    			return (int)$this->pt_civil_number(array($doc_number));
    			break;
    		...
    		case 7://Portuguese civil card
    			return (int)$this->pt_civil_card_number(array($doc_number));
    			break;
    	}
     ...
     * @param Array $params Array with the [0]document expiry date, [1]the document type and [2] current date. The document type must be an integer.
     * 						Supported document types:
     * 							1 - Portuguese identification number
     * 							2 - Residence authorization title number
     * 							3 - Personal ballot number
    ...
    function iddoc_date($params){
    	...
    	$date_now = $params[2];
    	if($doc_type!=99)
    		return (int)$this->pt_doc_date(array($doc_date, $date_now));
