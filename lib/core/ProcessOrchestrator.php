...
class ProcessOrchestrator {
  ...
  static function setEventParamsByUrl($contextId=null) {
    $contextId = (isset($contextId)) ? $contextId : self::getContextId();
    $ignoreKeys = array(QueryStringParam::ID=>1, QueryStringParam::FORM=>1,QueryStringParam::ACTION=>1,QueryStringParam::TRACE=>1,QueryStringParam::PROCESS=>1,QueryStringParam::ACTION_VALUE=>1, QueryStringParam::EVENT=>1, QueryStringParam::BASE_APPLICATION=>1, QueryStringParam::ID_CONTEXT=>1);
