	        ...
	        try {
	            ...
	            //foreach ($methods as $instruction) {
                    ...
                    //Legacy
	                  ...
	                  $newParams['_entity'] = isset($newParams['_entity']) ? $newParams['_entity'] : $legacyParams['table']; unset($newParams['table']);
	                  $newParams['_attributes'] = isset($newParams['_attributes']) ? $newParams['_attributes'] : $legacyParams['fields']; unset($newParams['fields']);
	                  $newParams['_sort'] = isset($newParams['_sort']) ? $newParams['_sort'] : $legacyParams['order']; unset($newParams['order']);
	                  $newParams['_pageNum'] = isset($newParams['_pageNum']) ? $newParams['_pageNum'] : $legacyParams['pagenum']; unset($newParams['pagenum']);
	                  $newParams['_pageSize'] = isset($newParams['_pageSize']) ? $newParams['_pageSize'] : $legacyParams['pagesize']; unset($newParams['pagesize']);
