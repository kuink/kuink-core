...
class Screen {
	 ...
	 * 
	 * @param $runtime -
	 *        	the runtime that holds this screen
	 * @param $nodeConfiguration -
	 *        	The node configuration to get access to node configuration
	 * @param $nodeManager -
	 *        	The node configuration to get access to the xml configuration
	 */
